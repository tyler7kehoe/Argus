...
class Set(commands.Cog):
    ...
    async def record(self, ctx: Context,
        ...
        await ctx.respond(embed=embed_builder.make_embed("Wallet Recorded", ctx.author, f"```{content}```", embed_builder.embed_color.NEUTRAL, "Created by DabMan"),ephemeral=True)
